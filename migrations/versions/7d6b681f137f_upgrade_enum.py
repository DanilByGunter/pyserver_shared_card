...
Revision ID: 7d6b681f137f
Revises: 
Create Date: 2023-12-24 15:52:28.127754
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['id'], ['user_account.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.Column('status', postgresql.ENUM('local', 'globals', name='group_status'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
